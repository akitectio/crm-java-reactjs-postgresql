...
<div class="login-page-container">
            <div class="${properties.kcSlideClass!}">
            <img src="${url.resourcesPath}/img/home-new-banner.png"  style="
                width: 80%;
                margin: 25% 0 0 5%;
                align-items: center;
    ...
    <#nested "socialProviders">
      ...
      <#if displayMessage && message?has_content && (message.type !=' warning' || !isAppInitiatedAction??)>
        <#if message.type='success'>
          <div id='alert-box' class=" alert-success pf-c-alert pf-m-inline pf-m-success">
            <div class="pf-c-alert__icon">
              <span class="${properties.kcFeedbackSuccessIcon!}"></span>
            </div>
            <span class="${properties.kcAlertTitleClass!}">
              ${msg("alertSentEmailPassword")}
            </span>
          </div>
        </#if>
      </#if>
